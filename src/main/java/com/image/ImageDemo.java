...
public class ImageDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //输出目录
        String rootPath = "C:\\Users\\geshijie\\Desktop\\";


        //这里文字的size，建议设置大一点，其实就是像素会高一点，然后缩放后，效果会好点，最好是你实际输出的倍数，然后缩放的时候，直接按倍数缩放即可。
        Font font = new Font("微软雅黑", Font.PLAIN, 130);

        int[] arr = getWidthAndHeight("看购用户用微信扫描", font);
        createImage("看购用户用微信扫描", font, arr,Paths.get(rootPath, "sojson-image.png").toFile());
    }
    ...
    public static void createImage(String text, Font font,int[] arr, File outFile)
            throws Exception {
